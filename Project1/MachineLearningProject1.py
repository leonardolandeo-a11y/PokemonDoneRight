...
print("\n")
#Instance of KMeans
Cluster = KMeans(n_clusters=3) #We're using 18 clusters. Because we have 18 classes of pokemon 
...
PokemonDataSet_Name_Cluster["ClusterPokemon"] = PokemonDataSet_Name_Cluster["ClusterPokemon"].replace({
